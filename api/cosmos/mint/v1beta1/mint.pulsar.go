...
var (
	...
	fd_Params_decay_start_height    protoreflect.FieldDescriptor
...
func init() {
	...
	fd_Params_decay_start_height = md_Params.Fields().ByName("decay_start_height")
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.DecayStartHeight != uint64(0) {
		value := protoreflect.ValueOfUint64(x.DecayStartHeight)
		if !f(fd_Params_decay_start_height, value) {
			return
		}
	}
	if x.DecayRate != "" {
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.mint.v1beta1.Params.decay_start_height":
		return x.DecayStartHeight != uint64(0)
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.mint.v1beta1.Params.decay_start_height":
		panic(fmt.Errorf("field decay_start_height of message cosmos.mint.v1beta1.Params is not mutable"))
	case "cosmos.mint.v1beta1.Params.decay_rate":
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.DecayStartHeight != 0 {
			n += 1 + runtime.Sov(uint64(x.DecayStartHeight))
		}
		l = len(x.DecayRate)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.DecayStartHeight != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.DecayStartHeight))
			i--
			dAtA[i] = 0x38
		}
		if x.BlocksPerYear != 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 7:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field DecayStartHeight", wireType)
				}
				x.DecayStartHeight = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.DecayStartHeight |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
type Params struct {
	...
	// decay rate
	DecayRate string `protobuf:"bytes,8,opt,name=decay_rate,json=decayRate,proto3" json:"decay_rate,omitempty"`
}
...
func (x *Params) GetDecayStartHeight() uint64 {
	if x != nil {
		return x.DecayStartHeight
	}
	return 0
}
...
var file_cosmos_mint_v1beta1_mint_proto_rawDesc = []byte{
	...
	0x73, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xf2, 0x04, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73,
	...
	0x65, 0x72, 0x59, 0x65, 0x61, 0x72, 0x12, 0x2c, 0x0a, 0x12, 0x64, 0x65, 0x63, 0x61, 0x79, 0x5f,
	0x73, 0x74, 0x61, 0x72, 0x74, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x04, 0x52, 0x10, 0x64, 0x65, 0x63, 0x61, 0x79, 0x53, 0x74, 0x61, 0x72, 0x74, 0x48, 0x65,
	0x69, 0x67, 0x68, 0x74, 0x12, 0x55, 0x0a, 0x0a, 0x64, 0x65, 0x63, 0x61, 0x79, 0x5f, 0x72, 0x61,
	...
	0x52, 0x09, 0x64, 0x65, 0x63, 0x61, 0x79, 0x52, 0x61, 0x74, 0x65, 0x3a, 0x1d, 0x8a, 0xe7, 0xb0,
